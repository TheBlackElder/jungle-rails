...
RSpec.describe User, type: :model do
  before(:each) do 
    @user = User.create(first_name: "Elisabeth", last_name: "Clarke", email: "elisabeth@email.com", password: "easyEver", password_confirmation: "easyEver" )
  end
  ...
  describe 'Validations' do
    ...
    it "has a valid password" do
      @user= User.new(first_name: "Elisabeth", last_name: "Clarke", email: 'elisabeth@email.com', password:"", password_confirmation: "")
      expect(@user).to_not be_valid
    ...
    it "has a unique email" do
      @user1= User.create(first_name: 'Elisabeth', last_name: "Clarke", email: 'elisabethh@email.com', password:'easy', password_confirmation: 'easy')
      @user2= User.create(first_name: 'Elisabeth', last_name: "Clarke", email: 'ELISABETHH@EMAIL.COM', password:'easy', password_confirmation: 'easy')
